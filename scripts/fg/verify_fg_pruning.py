...
def test_pruning_integration():
    ...
    with patch("gear_optimizer.solver.taichi_gem.force_greats.api.solve_force_greats_finder_gpu") as mock_gpu_finder:
        ...
        with patch("gear_optimizer.solver.scoring.force_greats.evaluate_force_greats") as mock_eval:
            ...
            # Run
            force_greats.run_force_greats_hill_climb(stats, calc_song, ref_arrays, use_gpu=True)
            ...
            counts_list = args[5]  # 6th positional arg is counts_list

...
def evaluate_loadout(gear_names, mini_names, gears_by_name, minis_by_name, ref_arrays, calc_song, cfg, verbose=False):
    ...
    result = solve_best_fever_combination(
        cfg, stats, calc_song, ref_arrays, silent=True, skip_optimizer=False,
...
def main():
    ...
    ref_score, ref_stats = evaluate_loadout(
        REFERENCE_LOADOUT["gear"], REFERENCE_LOADOUT["minis"],
        gears_by_name, minis_by_name, ref_arrays, calc_song, cfg, verbose=True
    )
    print(f"\nReference loadout:")
    ...
    your_score, your_stats = evaluate_loadout(
        YOUR_LOADOUT["gear"], YOUR_LOADOUT["minis"],
        gears_by_name, minis_by_name, ref_arrays, calc_song, cfg
    )
    print(f"\nYour GA loadout:")
    ...
    print("-" * 52)
    for k in ["Perfect Points", "Combo Multiplier", "Fever Multiplier", "Fever Time", "Fever Fill Rate", "Vibe", "Chill", "Rush", "Beat", "Flow"]:

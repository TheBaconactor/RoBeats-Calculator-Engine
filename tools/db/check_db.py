...
rows = conn.execute(
    """
    SELECT score, fg_score, timestamp, details_json, gear_json
...
for i, r in enumerate(rows):
    ...
    print(
        f"  GemCounts: FM={gems.get('Fever Multiplier', 'N/A')}, PP={gems.get('Perfect Points', 'N/A')}, CM={gems.get('Combo Multiplier', 'N/A')}, OV={gems.get('Element', 'N/A')}"
    )

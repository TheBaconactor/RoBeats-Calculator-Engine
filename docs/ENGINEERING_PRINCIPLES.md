...
- Keep docs and tests aligned with meaningful behavior or policy changes.
...
- Update the relevant maintained reference in `docs/` when a change affects behavior, policy, or engineering guidance.

...
from gear_optimizer.core.team_buff import (
    ...
    resolve_selected_team_buff_from_cfg,
    resolve_selected_team_buff_from_cfg_dict,
)
...
def test_optimizer_team_buff_policy_ignores_stale_config_entries():
    ...
    assert resolve_selected_team_buff_from_cfg(cfg) == "T5"
    assert resolve_baseline_team_buff_from_cfg(cfg) == "T5"
    assert resolve_selected_team_buff_from_cfg_dict(cfg_dict) == "T5"

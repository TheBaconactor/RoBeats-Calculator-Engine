...
def test_schema_v15_creates_frontend_views_and_unified_behavior(tmp_path):
    ...
    try:
        ...
        # Song A: tiered row should appear in loadouts_unified.
        ...
        # Song B: different tier should be preserved in loadouts_unified.
        ...
        assert dict(row) == {"team_buff": "T10", "loadout_hash": "tierhash2", "score": 11, "source_table": "team_buff_loadouts"}

...
def test_gather_batch_keeps_adjacent_exact_requests_in_one_queue_batch():
    ...
    executor._request_queue.put(_request(GpuRequestType.EXACT_BASE_SEARCH, 1))
    executor._request_queue.put(_request(GpuRequestType.EXACT_BASE_SEARCH, 2))

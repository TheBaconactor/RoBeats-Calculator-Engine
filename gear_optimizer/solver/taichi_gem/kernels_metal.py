...
def create_metal_kernels():
    ...
    global ga_write_best_results_from_key_kernel, _kernels_created
    
    if _kernels_created:
        return
    
    # Import optimize_core_device at kernel creation time (after fields bound to main kernels too)

...
_EXACT_COMPATIBLE_PREDECESSOR_VERSIONS: dict[str, tuple[str, ...]] = {
    # Custom-cache routing and exact pre-allocation admission do not change admitted frontier or
    # compact bundle bytes. Official caches retain the complete byte-proven V31 lineage.
    "fg-response-frontier-visible-first-v31+logic-9a025b3ab4a1": (

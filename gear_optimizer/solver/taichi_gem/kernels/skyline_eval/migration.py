...
@ti.kernel
def skyline_island_migration_kernel(
    n_genomes: ti.i32,
    n_islands: ti.i32,
    ...
    - No skyline_download_scores()
    - No skyline_download_population_indices()
    - No skyline_upload_population_indices()
    ...
    for isl in range(n_islands):
        ...
        for m in range(k):
            ...
            if src_g >= 0 and dst_g >= 0:
                ...
                kernels_helpers.skyline_scores[dst_g] = kernels_helpers.skyline_scores[src_g]


@ti.kernel
def skyline_island_migration_runs_kernel(
    n_runs: ti.i32,
    ...
    if n_runs_i > 0 and n_genomes_per_run_i > 0:
        ...
        # Synchronous migration: select all emigrants/replacements first (based on pre-migration scores),
        # then apply copies. This matches skyline_island_migration_kernel behavior under Taichi's parallelization
        # and avoids "cascading" migrations within a single call.

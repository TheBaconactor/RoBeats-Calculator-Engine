"""
Taichi Kernels - skyline FT/FF combo search.
...
@ti.kernel
def skyline_find_best_combo_key_kernel(
    n_genomes: ti.i32,
    n_combos: ti.i32,
    combo_offset: ti.i32,
    combo_count: ti.i32,
    ...
    if ti.static(IS_METAL):
        ...
        waves = ti.cast(kernels_helpers.SKYLINE_FTFF_REDUCE_WAVE_STRIDE, ti.i32)
        shared_waves_key = simt.block.SharedArray((kernels_helpers.SKYLINE_FTFF_REDUCE_WAVE_STRIDE,), ti.u64)
        shared_waves_pp = simt.block.SharedArray((kernels_helpers.SKYLINE_FTFF_REDUCE_WAVE_STRIDE,), ti.i32)
        shared_waves_cm = simt.block.SharedArray((kernels_helpers.SKYLINE_FTFF_REDUCE_WAVE_STRIDE,), ti.i32)
        shared_waves_fm = simt.block.SharedArray((kernels_helpers.SKYLINE_FTFF_REDUCE_WAVE_STRIDE,), ti.i32)
        shared_waves_ov = simt.block.SharedArray((kernels_helpers.SKYLINE_FTFF_REDUCE_WAVE_STRIDE,), ti.i32)
        ...
        for tid in range(total_threads):
            ...
            if lane == 0:
                ...
                for i in range(1, kernels_helpers.SKYLINE_FTFF_REDUCE_WAVE_STRIDE):

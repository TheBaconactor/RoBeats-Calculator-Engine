...
def is_cached_force_valid_for_bellman(cached_force_obj, expected_selected_element, center_ft, center_ff) -> bool:
    ...
    try:
        ...
        logger.debug(f"cache_validation:is_cached_force_valid_for_bellman: {e}")
        return False

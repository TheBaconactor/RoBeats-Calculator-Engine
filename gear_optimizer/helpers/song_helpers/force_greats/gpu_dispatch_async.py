...
def warmup_force_greats_bellman_runtime_imports() -> None:
    ...
    The old breakpoint warmup was removed with the production Bellman
    route. Bellman warmup only imports the Bellman module; kernel compilation
    still happens on the first real fixed-stats solve.
    """

...
def merge_databases(
    ...
    try:
        ...
        # Ensure both DBs are migrated to the latest schema before attaching.
        # This avoids column mismatches (e.g. newly added optional columns).
        try:
            tmp = get_db_connection(secondary_db_path)
            tmp.close()
        except Exception:
            pass

...
local v_u_5 = require(game.ReplicatedStorage.Lobby.Menus.DJRequestUI)
return {
    ["new"] = function(_, p6, p7) --[[ Name: new ]] --[[ Line: 11 ]]
        --[[ Upvalues: (copy 1): v_u_4, (copy 2): v_u_3, (copy 3): v_u_1, (copy 4): v_u_5, (copy 5): v_u_2 ]]
        return v_u_4:new(p6, p7, v_u_3.NPC.NPC_DJ, "DJ Hiku", "RoBeats Radio", game.ReplicatedStorage.LobbyElementProtos.CharacterOverlay.DialoguePopupDJRequest, true, function(p8, _, p9) --[[ Line: 20 ]]
            --[[ Upvalues: (ref 1): v_u_1 ]]
            p8:play_anim((p8:load_anim(p9, v_u_1.ANIM_DJ_IDLE)))

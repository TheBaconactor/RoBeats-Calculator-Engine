...
return {
    ["new"] = function(_, p5, p6) --[[ Name: new ]] --[[ Line: 9 ]]
        ...
        return v_u_4:new(p5, p6, v_u_3.NPC.NPC_Guild, "Teresa", "Teams", game.ReplicatedStorage.LobbyElementProtos.CharacterOverlay.DialoguePopupTeam, true, function(p7, _, p8) --[[ Line: 18 ]]
            --[[ Upvalues: (ref 1): v_u_1 ]]
            p7:play_anim((p7:load_anim(p8, v_u_1.ANIM_TEAM_IDLE)))
        end, function(p9, _, _) --[[ Line: 22 ]]
            --[[ Upvalues: (ref 1): v_u_2 ]]
            p9._guild_manager:move_camera_to_guild_position(p9)
            p9._guild_manager:show_guild_info_action(p9)

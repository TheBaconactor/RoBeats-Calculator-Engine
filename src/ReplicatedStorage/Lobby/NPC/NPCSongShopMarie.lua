...
return {
    ["new"] = function(_, p6, p7) --[[ Name: new ]] --[[ Line: 11 ]]
        ...
        return v_u_4:new(p6, p7, v_u_3.NPC.NPC_Marie, "Marie", "Song Shop", game.ReplicatedStorage.LobbyElementProtos.CharacterOverlay.DialoguePopupSongShop, true, function(p8, _, p9) --[[ Line: 20 ]]
            --[[ Upvalues: (ref 1): v_u_1 ]]
            p8:play_anim((p8:load_anim(p9, v_u_1.ANIM_MARIE_IDLE)))

...
local v_u_9 = v2:new():push_back_table_list({
    {
        ["Guild"] = "Oh, my~! A new challenger approaches. Find the right team and you just might reach your full potential.",
        ["Firsttime"] = true
    },
    {
        ["Guild"] = "Mmhmm... I see great things in your future. But only if you find the right team to support you!"
    }
})
local v_u_10 = v2:new():push_back_table_list({
    {
        ["Guild"] = "Want to create a team? For a small sum, you can do just that. As the rightful owner, it\'ll be yours to manage."
    },
    {
        ["Guild"] = "Want to join a team? Find an Owner or Admin, and they can send you an invitation."
    },
    {
        ["Guild"] = "Your team might enter weekly leaderboards. Earn points from completing missions to support them!"
    },
    {
        ["Guild"] = "Find a team that works for your chosen element. You\'ll get a boost in their selected element!"
    }
})
v7.new = function(_, p_u_11, p_u_12, p_u_13, p_u_14) --[[ Name: new ]] --[[ Line: 34 ]]
    ...
    v15.cons = function(p_u_18) --[[ Name: cons ]] --[[ Line: 40 ]]
        ...
        v_u_16 = v_u_5:new("Teresa", p_u_14.NPCDialogue, v_u_3:new(p_u_13, p_u_14.PrimaryPart, p_u_14.NPCDialogue))
        v_u_17 = p_u_12:add_cycle_element(p_u_11, 1, v_u_4:new(v_u_3:new(p_u_12, p_u_14.PrimaryPart, p_u_14.NPC), p_u_11._spui, function() --[[ Line: 50 ]]
            --[[ Upvalues: (ref 1): p_u_11, (ref 2): v_u_6, (copy 3): p_u_18 ]]
            p_u_11._sfx_manager:play_sfx(v_u_6.SFX_BUTTONPRESS)
            p_u_18:load_from_pressed_dialogues("Guild")
    ...
    v15.load_dialogue = function(_, p25) --[[ Name: load_dialogue ]] --[[ Line: 78 ]]
        ...
        if p25 == nil then
            ...
            local l_Guild_0 = p25.Guild
            if l_Guild_0 == nil then
                v_u_16:finish()
            else
                p_u_11._update_enqueue_fn:enqueue_function(function() --[[ Line: 83 ]]
                    --[[ Upvalues: (ref 1): v_u_16, (copy 2): l_Guild_0 ]]
                    v_u_16:display_text(l_Guild_0)
                end, 0)
            end;
        end;
    end;

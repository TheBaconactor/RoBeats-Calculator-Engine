...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Synthion (Synthia Iona) is an Korean American music producer, DJ, vocalist, instrumentalist, and VTuber. Classically trained since childhood, her energetic yet emotional \'love-core\' style represents the cross-section of dance music and anime soundtracks. Play her tracks \'Sky Blue\' and \'VIVIDVELOCITY\' in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniSynthion", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    --[[ Upvalues: (copy 1): v_u_2 ]]
    return {
        [v_u_2.Type.ColorBlue] = 11,
        [v_u_2.Type.ColorRed] = 4
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://14056914027";
end;

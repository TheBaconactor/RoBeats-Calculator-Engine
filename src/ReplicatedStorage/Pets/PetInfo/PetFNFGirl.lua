...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "That\'s how you do it! Usually found sitting on top of the speakers bopping her head to the music, Girlfriend is the damsel in distress to be saved by Boyfriend in Friday Night Funkin\'.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniFNFGirl", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    ...
    return {
        ...
        [v_u_2.Type.ColorPurple] = 8
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://10265825168";
end;

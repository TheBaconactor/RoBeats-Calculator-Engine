...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 8 ]]
    return "Here comes dat ducc... Meet future bass composer and ducc boi Kagi! Try their tracks \"Sparkle\" and \"Full Restore\" in RoBeats.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 10 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniKagi", p5, p4, function(p7, p8) --[[ Line: 11 ]]
...
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 29 ]]
    return "rbxassetid://124254717871892";
end;

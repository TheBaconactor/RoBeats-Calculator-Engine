...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Valentine\'s Lisa";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Usually manning the leaderboard front desk, Lisa jumped at the chance to host this special event. How many Valentines do you think she got?";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("LisaValentinesMini", p5, p4, function(p7, p8) --[[ Line: 10 ]]

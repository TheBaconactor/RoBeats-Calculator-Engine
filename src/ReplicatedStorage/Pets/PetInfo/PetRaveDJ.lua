...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "DJ Hiku: Party Mode";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Someone must have updated DJ Hiku - because somehow we\'ve activated Party Mode! Rave on with our playlist of all songs electronic and dance... ^_^";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniRaveDJ", p5, p4, function(p7, p8) --[[ Line: 10 ]]

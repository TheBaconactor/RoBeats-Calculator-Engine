...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Spring Festival Mattie";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "The melting of snow, the blooming of cherry blossoms... Wearing a traditional \'Kimono\', Mattie (who you\'ll normally see behind the Song Shop) is here to celebrate the passing of the new season. Spring is in the air!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniSpringMattie", p5, p4, function(p7, p8) --[[ Line: 10 ]]

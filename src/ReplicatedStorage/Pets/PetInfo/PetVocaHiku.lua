...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Voca-Hiku\'s here with a playlist of Vocaloid songs to enjoy! Vocaloid is a \'voice synthesizer\' popular in Japan (and often paired with iconic anime mascots). Keisei is a producer known for his Vocaloid songs featured on Japanese video site \'niconico\'. Play his song \'Bright City\' in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniVocaHiku", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    --[[ Upvalues: (copy 1): v_u_2 ]]
    return {
        [v_u_2.Type.ColorRed] = 13,
        [v_u_2.Type.ColorBlue] = 2
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://15099826972";
end;

...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 8 ]]
    return "A Tokyo-based producer with kitty mascot \'Hoshikake-kun\', who you might recognize from the art! Inspired by video games from childhood, their music evokes stories and scenery from classic titles of the past. Play their songs \'Pastel Planet\' and \'Kang-Fu Neko Punch!!\' in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 10 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniAaaa", p5, p4, function(p7, p8) --[[ Line: 11 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 22 ]]
    --[[ Upvalues: (copy 1): v_u_2 ]]
    return {
        [v_u_2.Type.ColorOrange] = 13,
        [v_u_2.Type.ColorGreen] = 5
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 29 ]]
    return "rbxassetid://17736921323";
end;

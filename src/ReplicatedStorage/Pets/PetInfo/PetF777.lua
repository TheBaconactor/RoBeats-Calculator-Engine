...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A Canadian producer known for his dance and techno music widely posted on social media. Character based off art from 2015 album \'The Dancing Dead\'. Play track 4 \'Monster Dance Off\' in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniF777", p5, p4, function(p7, p8) --[[ Line: 10 ]]

...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Bleep and Bass! Erik Bjarngard, known professionally as Bossfight, is a Swedish EDM/Dubstep producer. Courtesy of Monstercat, you can now jam to several of his songs in RoBeats. Try his songs \'Endgame\' and \'Overdose\' in-game!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniBossfight", p5, p4, function(p7, p8) --[[ Line: 10 ]]

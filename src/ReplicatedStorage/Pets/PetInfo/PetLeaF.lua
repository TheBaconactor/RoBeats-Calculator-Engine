...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A character based on the doujin MV for Japanese producer LeaF\'s song \'Armageddon\', animated by Optie. Okuu is the final boss of \'Subterranean Animism\', the 11th official game in the Touhou Project. Permission granted by Team Shanghai Alice.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniLeaF", p5, p4, function(p7, p8) --[[ Line: 10 ]]

...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Self-proclaimed Otaku-Music-Producer seatrus is on the scene! Specializing in a bass-heavy yet emotionally evocative style, seatrus has produced a wide range of club and doujin tracks featured in a variety of games. Try their tracks \'Karakuri\' and \'Viral Cleric\' featured in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniSeatrus", p5, p4, function(p7, p8) --[[ Line: 10 ]]

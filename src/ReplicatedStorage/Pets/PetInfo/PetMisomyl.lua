...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A character featured on the cover of Japanese producer duo MisoilePunch\'s 2018 album \'I Re:s\' (art by @sanapon7777). Find the songs \'LosTear\'n HeriX\' (Track 4) and \'MeTear\'n TruX\' (Track 6) in-game!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniMisomyl", p5, p4, function(p7, p8) --[[ Line: 10 ]]

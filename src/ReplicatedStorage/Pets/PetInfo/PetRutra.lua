...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Waaaah du lourd!!! A French EDM/House producer and longtime RoBeats collaborator. He\'s got a bunch of songs in RoBeats - why not play them all at once in the special VIP track \'Rutra - Mashup (for RoBeats)\'?";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniRutra", p5, p4, function(p7, p8) --[[ Line: 10 ]]

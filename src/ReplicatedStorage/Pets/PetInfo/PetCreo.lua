...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "An Austrian producer known for his creative EDM-inspired sound. When you hear the saxophone, you know it\'s going down!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniCreo", p5, p4, function(p7, p8) --[[ Line: 10 ]]

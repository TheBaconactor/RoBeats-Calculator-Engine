...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Apocalypse Survivor Starlet";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "The apocalypse is here - will you be one of the lucky few to make it? Join Survivor Starlet among any other fellow survivors, and make your way through the ruins in the \'Post-Apocalyptic Precinct\' stage!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 10 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniSurvivorStarlet", p5, p4, function(p7, p8) --[[ Line: 11 ]]

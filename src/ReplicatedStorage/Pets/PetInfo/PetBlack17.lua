...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Black17 Eternxlkz";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Black17 - Independence without Compromise. For a limited time, RoBeats has partnered with label Black 17 to bring you some of the top trending PHONK tracks in-game! Be sure to try Eternxlkz\'s track \'BRODYAGA FUNK\' while it\'s here in-game.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("Black17Mini", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://140195430743463";
end;

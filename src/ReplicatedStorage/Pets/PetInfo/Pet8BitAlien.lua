...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Chiptunes, also known as 8-bit music, is a retro genre with sounds reminiscent of those in vintage arcade, PC and console games of decades gone by. 8-bit Alien is here in all his pixellated glory to beep, boop and bop to these tracks in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniPixelAlien", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    ...
    return {
        ...
        [v_u_2.Type.ColorBlue] = 7
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://13015020926";
end;

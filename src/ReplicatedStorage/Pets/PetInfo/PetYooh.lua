...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Welcome to the Yoohsic Roomz - A Japanese trance/EDM artist with songs featured in SOUND VOLTEX and a variety of other rhythm games. Try their songs \'Ice Angel\' and \'Energy of the Star\' in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniYooh", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://103572361814470";
end;

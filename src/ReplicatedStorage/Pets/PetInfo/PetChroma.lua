...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Favorite things: Music, Games, Ice Cocoa, Natto, Miso Soup. Features: Quite forgetful, getting up early, laid back. On the internet, often seen as a mage (Kuro), dog (Taro) and robot (Boro) trio. You may have heard their song \'Dark Sheep\', which you can play in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniChroma", p5, p4, function(p7, p8) --[[ Line: 10 ]]

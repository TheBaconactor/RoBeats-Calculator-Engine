...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Come one, come all! Take a break from this sweltering heat and catch the coolest show in town, the RoBeats Summer Carnival - led by the one and only Ringmaster Roxie!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniRingmasterRoxie", p5, p4, function(p7, p8) --[[ Line: 10 ]]

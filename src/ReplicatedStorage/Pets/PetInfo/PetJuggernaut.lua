...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Juggernaut - a seemingly unstoppable force crushing whatever (or whoever) is in its path. A Japanese producer known for their prolific work in games and other collaborations. Character based off art from their album \'Distorted Heavens\'.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniJuggernaut", p5, p4, function(p7, p8) --[[ Line: 10 ]]

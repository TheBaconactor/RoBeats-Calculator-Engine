...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Santa\'s Helper Marsha";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "When Santa needs help picking out presents, who does he call? Using her extensive knowledge of the marketplace, she\'s sure to find a great deal.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniWinterMarsha", p5, p4, function(p7, p8) --[[ Line: 10 ]]

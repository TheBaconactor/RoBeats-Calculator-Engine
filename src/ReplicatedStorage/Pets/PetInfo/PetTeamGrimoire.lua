...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A Japanese \'Hardcore\' producer influenced by a eclectic range of styles: Folk, Classical, Gothic and Baroque and more. Character from their 2018 album \'Restriction 3\'. Play track 3 \'COCA\' from this album in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniTeamGrimoire", p5, p4, function(p7, p8) --[[ Line: 10 ]]

...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "New Year\'s Bunny-Girl Zara";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Pop a cork and make a toast! Let\'s count down the days, hours, minutes and seconds to the big moment. Zara\'s all dressed-up and here to wish you a very \'Happy New Year\'!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniBunnyZara", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    ...
    return {
        ...
        [v_u_2.Type.ColorPurple] = 14
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://15787180624";
end;

...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "An American electronic artists featured on the Monstercat label. You may know him from his track \'LUV U NEED U\', featured in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniSlushii", p5, p4, function(p7, p8) --[[ Line: 10 ]]

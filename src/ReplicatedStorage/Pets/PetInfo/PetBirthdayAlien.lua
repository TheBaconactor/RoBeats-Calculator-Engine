...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Birthday Alien";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A Birthday Alien who comes around every year to celebrate the RoBeats Anniversary on March 15! (Technically it\'s not our real Birthday, just the day the game was moved to the RobeatsDev group. But we\'ll just ignore that for now...)";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniBirthdayAlien", p5, p4, function(p7, p8) --[[ Line: 10 ]]

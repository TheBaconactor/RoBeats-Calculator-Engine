...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 8 ]]
    return "Let\'s see what this spell does... Japanese Producer \'BlackY\' (known for their work in a variety of rhythm games) has weaved an all-new playlist of tracks available in RoBeats! Try their songs \'Tarantella\' and \'Crimsonate\' in-game.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 10 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniBlackY", p5, p4, function(p7, p8) --[[ Line: 11 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 22 ]]
    ...
    return {
        ...
        [v_u_2.Type.ColorPurple] = 4
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 29 ]]
    return "rbxassetid://93575036757871";
end;

...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Snail\'s House";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A sound traveler - meet Snail-chan! The mascot of Snail\'s House, a Japanese Electronic/Kawaii Bass House producer. With antennae on her head and a snail\'s shell on her back, Snail-chan is ready for adventure!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniUjico", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://116149985522704";
end;

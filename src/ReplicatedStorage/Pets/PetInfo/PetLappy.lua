...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Hello, this is Lappy, a lover of games and music. Known for their fan works inspired by the game \'Arknights\'. Their character was inspired by \'Lappland\', a blood-thirsty wolf girl and daughter of a mafia boss. Play their songs \'Try Resisting Me\' and \'Counter Blade\' in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniLappy", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://98175893913291";
end;

...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "\\sum_{k=1}^{6}k+1... A French producer you may know from popular tracks \"Galaxy Collapse\" or \"Scattered Faith\". Based off art from Se-U-Ra!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniKurokotei", p5, p4, function(p7, p8) --[[ Line: 10 ]]

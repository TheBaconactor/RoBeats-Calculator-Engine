...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Tomoyuki Hamada, better known as t+pazolite, is a hardcore music producer and longtime member of the HARDCORE TANO*C circle. His C.H.S label stands for \"Cutie & Headshaking Sounds\". Play his song \'Chartreuse Green\' in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniTPazolite", p5, p4, function(p7, p8) --[[ Line: 10 ]]

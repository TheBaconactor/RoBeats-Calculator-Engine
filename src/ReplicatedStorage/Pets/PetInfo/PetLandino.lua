...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "James Landino (also known in Roblox as \'Bloxdino\') is an American video game/anime music composer and touring international DJ bridging the gap of electronic music and fandom culture.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniLandino", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    --[[ Upvalues: (copy 1): v_u_2 ]]
    return {
        [v_u_2.Type.ColorGreen] = 13
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 27 ]]
    return "rbxassetid://9469821993";
end;

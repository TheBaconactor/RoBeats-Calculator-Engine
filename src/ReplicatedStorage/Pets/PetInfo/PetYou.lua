...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Nice to meet (you)! Tokyo-based DJ/Producer, head of J-NERATION, and creator of club music with a focus on pop sounds. Featured in a variety of games - now including RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniYou", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    --[[ Upvalues: (copy 1): v_u_2 ]]
    return {
        [v_u_2.Type.ColorGreen] = 14
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 27 ]]
    return "rbxassetid://17087396786";
end;

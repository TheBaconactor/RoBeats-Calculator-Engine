...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Viyella (full name Viyella Vane) is a mysterious girl dressed in an old-fashioned maid\'s outfit, who always seems to be holding her stuffed bear. She is featured in Japanese producer Laur\'s works, in songs such as \'Viyella\'s Destiny\' and \'Viyella\'s Memory\'.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniLaur", p5, p4, function(p7, p8) --[[ Line: 10 ]]

...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A half-angel half-demon OC by @Ariimaw, who regularly appears in cover art for music from Geoxor. maw maw maw!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniGeoxor", p5, p4, function(p7, p8) --[[ Line: 10 ]]

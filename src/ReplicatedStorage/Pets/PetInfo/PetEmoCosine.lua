...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A Japanese Future House/Jersey Bass producer with an unique style characterized by fast \'bouncy\' grooves and kawaii-influenced samples. Featured in a variety of games, now including RoBeats! Play their songs \'Delusion\' and \'Magenta Potion\' in-game.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniEmoCosine", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "http://www.roblox.com/asset/?id=14305712728";
end;

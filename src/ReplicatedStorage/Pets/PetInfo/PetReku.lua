...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Japanese producer and self described Rhythm Game Enthusiast. Their music has been featured in many Rhythm Games... now including RoBeats! Try their tracks \"ELYXiVN ELYXiUM\" and \"INFiNiTE ENERZY -Overdoze-\" (and more).";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniReku", p5, p4, function(p7, p8) --[[ Line: 10 ]]

...
-- Decompiled at: 11/8/2025, 4:21:58 PM
...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Asteroid\'s Dream";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "A character from the 2021 track by Japanese producer brz1128, made for music competition \'THE BMS OF FIGHTERS XVI -NEO DYSTOPIA-\' (BOFXVI) under team \'Bless of Muse\'. From the artist: It\'s a heart-rending four-on-the-floor beat, thank you very much! Art by @4ra8_.";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniBRZ", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    --[[ Upvalues: (copy 1): v_u_2 ]]
    return {
        [v_u_2.Type.ColorBlue] = 10,
        [v_u_2.Type.ColorOrange] = 5
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://9300867865";
end;

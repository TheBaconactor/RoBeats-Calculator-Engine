...
v3.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 6 ]]
    return "Trailblazing Trance Zara";
end;
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Trailblaze with Trance Zara! Trance music is known to induce a state of hypnotism and heightened consciousness - reach the next level with Trance Zara and our Trance-inspired playlist. Try songs \'Nightline\' by Shandy Kubota, and \'Wings\' by YooH in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniTranceZara", p5, p4, function(p7, p8) --[[ Line: 10 ]]
...
v3.get_color_statmodifierobj = function(_) --[[ Name: get_color_statmodifierobj ]] --[[ Line: 21 ]]
    ...
    return {
        ...
        [v_u_2.Type.ColorGreen] = 8
    };
end;
v3.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 28 ]]
    return "rbxassetid://108337655601177";
end;

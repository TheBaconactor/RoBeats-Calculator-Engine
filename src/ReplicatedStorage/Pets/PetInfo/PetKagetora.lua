...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Kagetora - Nice to meet you! A self-taught composer influenced by \'Psychedelic Trance\' and melodic Japanese-style music. Creator of label \'Greatoaks Music\'. Featured with works in a variety of games (now including RoBeats!). Try their songs \'Critication\' and \'Time to Beat the Odds\'!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniKagetora", p5, p4, function(p7, p8) --[[ Line: 10 ]]

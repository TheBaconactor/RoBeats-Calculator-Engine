...
v3.get_description = function(_) --[[ Name: get_description ]] --[[ Line: 7 ]]
    return "Born in Toronto as Caroline Cecil, she spent her formative years as a competitive figure skater before a fateful accident brought a new passion for production into focus.  You may know her from her track \'CRY\', featured in RoBeats!";
end;
v3.create_character = function(_, p4, p5, p_u_6) --[[ Name: create_character ]] --[[ Line: 9 ]]
    --[[ Upvalues: (copy 1): v_u_1 ]]
    v_u_1:spawn_pet_npc_from_name("MiniWhippedCream", p5, p4, function(p7, p8) --[[ Line: 10 ]]

...
v5.apply_appearance_async = function(_, p_u_6, p_u_7) --[[ Name: apply_appearance_async ]] --[[ Line: 20 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.NewYearsBowtie, function(p8) --[[ Line: 21 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_6, (copy 3): p_u_7 ]]
        if p8 then
            v_u_1:attach_character_accessory(p_u_6, p8)
        end;
        local _, _, v9, v10 = v_u_1:create_particle_emitter_accessory(p_u_6, "NeckAttachment", Vector3.new(2, 2, 0.05), "rbxassetid://11945363275")

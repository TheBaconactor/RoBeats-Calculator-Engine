...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Rush Chieftan\'s Garb";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    v_u_1:shirt_base_apply(p8, "rbxassetid://5512745647")
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoulderLeft", "LeftShoulderRigAttachment", "rbxassetid://5536678223", "rbxassetid://5512745229")
    ...
    v10.Orientation = Vector3.new(0, 0, 45)
    v10.Position = Vector3.new(0, 0, 0)
    v11.Offset = Vector3.new(-0.35, -0.15, 0)
    v11.Scale = Vector3.new(0.035, 0.035, 0.035)
    v_u_1:attach_character_accessory(p8, v9)
    local v12, v13, v14 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoulderRight", "RightShoulderRigAttachment", "rbxassetid://5536678223", "rbxassetid://5512745229")
    ...
    v13.Orientation = Vector3.new(0, 0, -45)
    v13.Position = Vector3.new(0, 0, 0)
    v14.Offset = Vector3.new(0.22, -0.1, 0)
    v14.Scale = Vector3.new(0.035, 0.035, 0.035)
    v_u_1:attach_character_accessory(p8, v12)
    local v15, v16, v17 = v_u_1:create_accessory_base(p8, p7:get_name() .. "HandLeft", "LeftWristRigAttachment", "rbxassetid://5536678223", "rbxassetid://5512745229")
    ...
    v17.Scale = Vector3.new(0.03, 0.03, 0.03)
    v_u_1:attach_character_accessory(p8, v15)
    local v18, v19, v20 = v_u_1:create_accessory_base(p8, p7:get_name() .. "HandRight", "RightWristRigAttachment", "rbxassetid://5536678223", "rbxassetid://5512745229")
    ...
    v20.Scale = Vector3.new(0.03, 0.03, 0.03)
    v_u_1:attach_character_accessory(p8, v18)
    v_u_4:attach_color_particle(v_u_5.Red, p8)
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 109 ]]
...
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 117 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 120 ]]
    return 3;
end;
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 123 ]]

...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "BodyBackAttachment", "rbxassetid://834619636", "rbxassetid://834620315")
    ...
    v8.Position = Vector3.new(0, -0.65, 0)
    v9.Offset = Vector3.new(-0.15, 0, 0)
    v9.Scale = Vector3.new(0.65, 0.65, 0.65)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 48 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=835779898";
end;
return v4;

...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 8 ]]
    return "Legendary Rebel\'s Scarf";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, _, v8 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://2391150916", "rbxassetid://2391174214")
    v8.Offset = Vector3.new(0, 0, -0.1)
    v8.Scale = Vector3.new(0.012, 0.011, 0.016)

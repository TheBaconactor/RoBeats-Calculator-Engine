...
v4.apply_appearance = function(_, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v6, v7, v8, v9 = v_u_1:create_accessory_base(p5, "GarcelloHat", "HatAttachment", "rbxassetid://8268270373", "")
    v9.Color = Color3.fromRGB(71, 61, 55)
    ...
    v8.Scale = Vector3.new(0.085, 0.085, 0.085)
    v_u_1:attach_character_accessory(p5, v6)
    local v10, v11, v12, v13 = v_u_1:create_accessory_base(p5, "GarcelloHair", "HairAttachment", "rbxassetid://8268270650", "")
    v13.Color = Color3.fromRGB(117, 181, 125)
    ...
    v12.Offset = Vector3.new(0, -0.35, 0)
    v12.Scale = Vector3.new(0.075, 0.05, 0.075)
    v_u_1:attach_character_accessory(p5, v10)
end;
...
v4.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 69 ]]
    return 25;
end;
v4.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 72 ]]
    return 2;
end;
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 75 ]]
    return "rbxassetid://8517947473";
end;
return v4;

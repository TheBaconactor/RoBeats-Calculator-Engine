...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "Autumn Festival Lisa\'s Hairpin";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 20 ]]
    ...
    local v_u_9 = v_u_5:new(1, function() --[[ Line: 21 ]]
        --[[ Upvalues: (copy 1): p_u_8 ]]
        p_u_8()
    end)
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.AutumnLisaHair, function(p10) --[[ Line: 24 ]]
...
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 32 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 35 ]]
    return 3;
end;
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 45 ]]
    return "rbxassetid://15000572656";
end;
return v6;

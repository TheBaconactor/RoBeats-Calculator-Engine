...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 16 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "HatAttachment", "rbxassetid://7523245234", "rbxassetid://1530656437")
    v9.Offset = Vector3.new(-0.025, -0.275, -0.15)
    v9.Scale = Vector3.new(1.1, 1.1, 1.1)
    v9.VertexColor = Vector3.new(0.1, 0, 0.12)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 51 ]]
    return "http://www.roblox.com/asset/?id=7534851689";
end;
return v4;

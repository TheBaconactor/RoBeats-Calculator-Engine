...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 20 ]]
    ...
    v_u_9:begin()
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.KagiHat, function(p10) --[[ Line: 24 ]]
...
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 42 ]]
    ...
    return {
        ...
        [v_u_3.Type.ComboMultiplier] = 8
    };
end;
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 49 ]]
    return "rbxassetid://100402612716133";
end;
return v6;

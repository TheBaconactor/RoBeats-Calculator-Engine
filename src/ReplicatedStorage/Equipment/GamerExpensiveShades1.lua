...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 8 ]]
    return "Gamer\'s Expensive Shades";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "http://www.roblox.com/asset/?id=138219004", "http://www.roblox.com/asset/?id=138220773")
    ...
    v8.Position = Vector3.new(0, -0.15, -0.43)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 49 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=138248066";
end;
return v4;

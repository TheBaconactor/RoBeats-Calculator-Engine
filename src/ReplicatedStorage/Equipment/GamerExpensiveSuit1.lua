...
v4.apply_appearance = function(_, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    v_u_1:shirt_base_apply(p5, "rbxassetid://119259289")
end;
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 31 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=119259290";
end;
return v4;

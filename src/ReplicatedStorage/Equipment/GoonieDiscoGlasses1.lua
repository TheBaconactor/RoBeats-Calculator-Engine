...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "http://www.roblox.com/asset/?id=12259103", "http://www.roblox.com/asset/?id=12259271")
    v7.AttachmentForward = Vector3.new(0, -0.1, -0.995)
    v7.AttachmentPos = Vector3.new(0, 0.3, 0.22)
    v7.AttachmentRight = Vector3.new(1, 0, 0)
    v7.AttachmentUp = Vector3.new(0, 0.995, -0.1)
    v8.Position = Vector3.new(0, -0.257, -0.328)
    v8.Orientation = Vector3.new(0, -0.257, -0.328)
    v9.Offset = Vector3.new(0, 0, -0.1)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 49 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=12520031";
end;
return v4;

...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Beat Cyborg\'s Helmet";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name(), v_u_2:slot_to_attachment_name(p7:get_avatar_slot()), "rbxassetid://5536661694", "rbxassetid://5512485346")
    ...
    v11.Offset = Vector3.new(0, -0.4, 0)
    v11.Scale = Vector3.new(0.03, 0.03, 0.03)

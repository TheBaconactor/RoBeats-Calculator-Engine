...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "FaceFrontAttachment", "rbxassetid://1192459566", "rbxassetid://1467298640")
    ...
    v9.Scale = Vector3.new(2.2, 2.2, 2.2)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 49 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=1536058591";
end;
return v4;

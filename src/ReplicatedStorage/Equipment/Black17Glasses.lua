...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "Eternxlkz\'s Black17 Glasses";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 18 ]]
    ...
    local v_u_9 = v_u_5:new(1, function() --[[ Line: 19 ]]
        --[[ Upvalues: (copy 1): p_u_8 ]]
        p_u_8()
    end)
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.Black17Glasses, function(p10) --[[ Line: 22 ]]
...
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 30 ]]
    return 25;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 33 ]]
    return 3;
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 36 ]]
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 44 ]]
    return "rbxassetid://138006106150694";
end;
return v6;

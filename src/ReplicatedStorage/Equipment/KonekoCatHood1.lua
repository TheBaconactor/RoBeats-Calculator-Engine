...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "http://www.roblox.com/asset/?id=135446047", "http://www.roblox.com/asset/?id=273374941")
    v7.AttachmentForward = Vector3.new(0, 0, -1)
    v7.AttachmentPos = Vector3.new(0, -0.03, 0.05)
    v7.AttachmentRight = Vector3.new(1, 0, 0)
    v7.AttachmentUp = Vector3.new(0, 1, 0)
    v8.Position = Vector3.new(0, 0.07, 0.05)
    v9.Scale = Vector3.new(0.85, 0.85, 0.85)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 48 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=273377471";
end;
return v4;

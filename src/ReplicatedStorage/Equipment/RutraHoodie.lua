...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    v_u_1:shirt_base_apply(p6, "http://www.roblox.com/asset/?id=6502401240")
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "NeckAttachment", "rbxassetid://4179850886", "rbxassetid://4186824071")

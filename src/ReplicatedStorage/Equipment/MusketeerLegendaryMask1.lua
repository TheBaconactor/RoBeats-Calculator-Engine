...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 8 ]]
    return "Legendary Musketeer\'s Mask";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, _, v8 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://2621436731", "rbxassetid://2307346161")
    v8.Offset = Vector3.new(0, 0.1, 0.09)
    v8.Scale = Vector3.new(0.1, 0.1, 0.1)
    v_u_1:attach_character_accessory(p6, v7)
end;
v4.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 29 ]]
    return 50;
end;
v4.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 32 ]]
    return 3;
end;
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 43 ]]
    return "rbxassetid://2623577121";
end;
return v4;

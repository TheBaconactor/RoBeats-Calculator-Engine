...
v3.apply_appearance = function(p4, p5) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v6, v7, v8 = v_u_1:create_accessory_base(p5, p4:get_name(), v_u_2:slot_to_attachment_name(p4:get_avatar_slot()), "rbxassetid://7189861381", "http://www.roblox.com/asset/?id=7189824325")
    ...
    v7.Orientation = Vector3.new(0.091, 180, -0.091)
    v7.Position = Vector3.new(0.25, -0.3, -0.86)
    v8.Offset = Vector3.new(0.26, -0.15, -0.5)

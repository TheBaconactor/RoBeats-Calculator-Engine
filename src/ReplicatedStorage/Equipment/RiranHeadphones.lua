...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 16 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "NeckAttachment", "rbxassetid://9511455044", "rbxassetid://9511455214")
    v7.AttachmentForward = Vector3.new(-0, 0, -1)
    v7.AttachmentPos = Vector3.new(-0, 0.025, -0.093)
    v7.AttachmentRight = Vector3.new(-1, 0, 0)
    v7.AttachmentUp = Vector3.new(0, 1, 0)
    v8.Orientation = Vector3.new(0, -180, 0)
    v8.Position = Vector3.new(-0, 0.025, -0.093)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 53 ]]
    return "rbxassetid://9719085141";
end;
return v4;

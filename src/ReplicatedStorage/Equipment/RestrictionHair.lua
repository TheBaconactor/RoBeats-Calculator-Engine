...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 16 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "HairAttachment", "rbxassetid://9592046639", "rbxassetid://9592046723")
    ...
    v8.Position = Vector3.new(0.01, 0.419, -0.014)
    v9.Offset = Vector3.new(0, 0, 0)
    v9.Scale = Vector3.new(1, 1, 1)
    v_u_1:attach_character_accessory(p6, v7)
    local v10, v11, v12 = v_u_1:create_accessory_base(p6, p5:get_name() .. "Horns", "HatAttachment", "rbxassetid://9592046947", "rbxassetid://9592047064")
    ...
    v11.Position = Vector3.new(-0.022, -0.336, 0.166)

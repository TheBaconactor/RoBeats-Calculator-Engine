...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    v_u_1:shirt_base_apply(p6, "rbxassetid://5512485584")
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name() .. "ShoulderLeft", "LeftShoulderRigAttachment", "rbxassetid://5263108475", "rbxassetid://5512485751")
    ...
    local v10, v11, v12 = v_u_1:create_accessory_base(p6, p5:get_name() .. "ShoulderRight", "RightShoulderRigAttachment", "rbxassetid://5263108475", "rbxassetid://5512485751")
    ...
    local v13, v14, v15 = v_u_1:create_accessory_base(p6, p5:get_name() .. "HandLeft", "LeftWristRigAttachment", "rbxassetid://5263018329", "rbxassetid://5512485179")
    ...
    local v16, v17, v18 = v_u_1:create_accessory_base(p6, p5:get_name() .. "HandRight", "RightWristRigAttachment", "rbxassetid://5263018329", "rbxassetid://5512485179")

...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Chill Samurai\'s Mask";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name(), v_u_2:slot_to_attachment_name(p7:get_avatar_slot()), "rbxassetid://4502886345", "rbxassetid://4503169253")
    ...
    v10.Position = Vector3.new(0, 0.096, -0.205)
    v11.Offset = Vector3.new(0, -0.05, -0.05)
    v11.Scale = Vector3.new(1, 1, 1)
...
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 38 ]]
    ...
    return {
        [v_u_3.Type.ColorBlue] = 17,
        [v_u_3.Type.ColorPurple] = 11,
        [v_u_3.Type.PerfectPoints] = 8
    };
end;

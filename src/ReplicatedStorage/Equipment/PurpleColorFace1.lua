...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "http://www.roblox.com/asset/?id=44521200", "http://www.roblox.com/asset/?id=162018756")
    ...
    v8.Position = Vector3.new(0, -0.049, -0.291)
    v9.Offset = Vector3.new(0, -0.05, 0)
    v9.Scale = Vector3.new(0.9, 0.983, 0.969)

...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Beat Cyborg\'s Jumpsuit Pants";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    v_u_1:pants_base_apply(p8, "rbxassetid://5512485513")
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name() .. "LegLeft", "LeftAnkleRigAttachment", "rbxassetid://5263075060", "rbxassetid://5512485433")
    ...
    v11.Offset = Vector3.new(0, 0.55, -0.05)
    v11.Scale = Vector3.new(0.03, 0.015, 0.035)
    v_u_1:attach_character_accessory(p8, v9)
    local v12, v13, v14 = v_u_1:create_accessory_base(p8, p7:get_name() .. "LegRight", "RightAnkleRigAttachment", "rbxassetid://5263075060", "rbxassetid://5512485433")
    ...
    v14.Offset = Vector3.new(0, 0.55, -0.05)
    v14.Scale = Vector3.new(0.03, 0.015, 0.035)
    v_u_1:attach_character_accessory(p8, v12)
    local v15, v16, v17 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoeLeft", "LeftAnkleRigAttachment", "rbxassetid://5263094687", "rbxassetid://5512485663")
    ...
    v16.Orientation = Vector3.new(0, -90, 0)
    v16.Position = Vector3.new(0, 0, 0)
    v17.Offset = Vector3.new(0.15, -0.15, 0)
    v17.Scale = Vector3.new(0.035, 0.05, 0.05)
    v_u_1:attach_character_accessory(p8, v15)
    local v18, v19, v20 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoeRight", "RightAnkleRigAttachment", "rbxassetid://5263094687", "rbxassetid://5512485663")
    ...
    v19.Orientation = Vector3.new(0, -90, 0)
    v19.Position = Vector3.new(0, 0, 0)
    v20.Offset = Vector3.new(0.15, -0.15, 0)
    v20.Scale = Vector3.new(0.035, 0.05, 0.05)
    v_u_1:attach_character_accessory(p8, v18)
    v_u_4:attach_color_particle(v_u_5.Orange, p8)
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 100 ]]
    --[[ Upvalues: (copy 1): v_u_3 ]]
    return {
        [v_u_3.Type.ColorOrange] = 18,
        [v_u_3.Type.ColorPurple] = 7,
        [v_u_3.Type.FeverTime] = 7,
        [v_u_3.Type.FeverFillRate] = 6
    };
end;
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 108 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 111 ]]
    return 3;
end;
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 114 ]]

...
v5.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 11 ]]
    return "Halloween Witch\'s Cloak";
end;
...
v5.apply_appearance_async = function(_, p_u_6, p_u_7) --[[ Name: apply_appearance_async ]] --[[ Line: 20 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.WitchCloakNeck, function(p8) --[[ Line: 21 ]]
...
v5.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 28 ]]
...
v5.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 36 ]]
    return 50;
end;
v5.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 39 ]]
    return 3;
end;
v5.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 42 ]]
    return "rbxassetid://11372253572";
end;
return v5;

...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "BodyBackAttachment", "rbxassetid://2313787336", "rbxassetid://2313792682")
    ...
    v9.Offset = Vector3.new(-0.03, 0, 0.1)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 47 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=2620475435";
end;
return v4;

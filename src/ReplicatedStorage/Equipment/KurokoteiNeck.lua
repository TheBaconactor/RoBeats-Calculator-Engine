...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.KurokoteiNecklace, function(p10) --[[ Line: 23 ]]

...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://5536547586", "rbxassetid://5506749536")
    ...
    v9.Scale = Vector3.new(0.045, 0.045, 0.045)

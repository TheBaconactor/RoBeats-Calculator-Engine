...
v3.apply_appearance = function(p4, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v6, v7 = v_u_1:create_accessory_base(p5, p4:get_name(), v_u_2:slot_to_attachment_name(p4:get_avatar_slot()), "http://www.roblox.com/asset/?id=35624672", "http://www.roblox.com/asset/?id=35624645")
    ...
    v7.Position = Vector3.new(-0, -0.07, 0)

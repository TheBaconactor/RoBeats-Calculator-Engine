...
v4.apply_appearance = function(_, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v6, v7, v8, _ = v_u_1:create_accessory_base(p5, "KobaryoGlasses", "FaceFrontAttachment", "rbxassetid://10034383560", "rbxassetid://10034350857")
    v6.AttachmentForward = Vector3.new(-1, 0, -0)
    v6.AttachmentPos = Vector3.new(-0.072898865, 0.11307573, -0.00030517578)
    v6.AttachmentRight = Vector3.new(0, 0, -1)
    v6.AttachmentUp = Vector3.new(0, 1, 0)
    v7.Position = Vector3.new(-0.069, 0, 0)
    v7.Orientation = Vector3.new(0, 90, 0)

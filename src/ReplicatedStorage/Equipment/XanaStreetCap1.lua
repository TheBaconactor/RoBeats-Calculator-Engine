...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "http://www.roblox.com/asset/?id=17424204", "http://www.roblox.com/asset/?id=17424198")
    v7.AttachmentForward = Vector3.new(0, 0, -1)
    v7.AttachmentPos = Vector3.new(0, 0.1, -0.3)
    v7.AttachmentRight = Vector3.new(1, 0, 0)
    v7.AttachmentUp = Vector3.new(0, 1, 0)
    v8.Position = Vector3.new(0, 0.2, -0.3)
    v9.Offset = Vector3.new(0, 0, 0)
    v9.Scale = Vector3.new(1.05, 1.05, 1.05)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 49 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=17903982";
end;
return v4;

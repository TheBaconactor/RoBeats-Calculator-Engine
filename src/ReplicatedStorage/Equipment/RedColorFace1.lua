...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://4502956189", "http://www.roblox.com/asset/?id=4503169016")
    ...
    v8.Position = Vector3.new(0, -0.349, 0.171)
    v9.Offset = Vector3.new(0, 0, 0)
    v9.Scale = Vector3.new(0.969, 0.983, 0.969)

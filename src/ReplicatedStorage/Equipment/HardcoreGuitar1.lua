...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "BodyBackAttachment", "rbxassetid://657547276", "rbxassetid://928773918")
    ...
    v8.Position = Vector3.new(0, -0.15, 0)
    v8.Orientation = Vector3.new(0, -180, 35)
    v9.Offset = Vector3.new(0, 0, -0.25)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 49 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=928913996";
end;
return v4;

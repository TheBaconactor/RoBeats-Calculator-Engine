...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "Heavy Metal Starlet\'s Hat";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    v_u_9:begin()
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.RockHat, function(p10) --[[ Line: 23 ]]
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 50 ]]
    return "rbxassetid://115891362824602";
end;
return v6;

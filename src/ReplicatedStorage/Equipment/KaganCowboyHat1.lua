...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "http://www.roblox.com/asset/?id=62242907", "rbxassetid://1028722257")
    v7.AttachmentForward = Vector3.new(0, 0, -1)
    v7.AttachmentPos = Vector3.new(0, -0.25, 0)
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 47 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=1028840446";
end;
return v4;

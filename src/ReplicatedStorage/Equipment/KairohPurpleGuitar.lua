...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://6737655193", "http://www.roblox.com/asset/?id=6737656689")
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 47 ]]
    return "http://www.roblox.com/asset/?id=6737670021";
end;
return v4;

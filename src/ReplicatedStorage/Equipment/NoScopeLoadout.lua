...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.NoScopeGun, function(p10) --[[ Line: 23 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.NoScopeDuffelBag, function(p11) --[[ Line: 29 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p11 then
...
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 37 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 40 ]]
    return 3;
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 43 ]]
    --[[ Upvalues: (copy 1): v_u_3 ]]
    return {
        [v_u_3.Type.ColorPurple] = 3,
        [v_u_3.Type.FeverFillRate] = 7,
        [v_u_3.Type.FeverMultiplier] = 7,
        [v_u_3.Type.ComboMultiplier] = 7
    };
end;
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 51 ]]
    return "rbxassetid://15001615941";
end;
return v6;

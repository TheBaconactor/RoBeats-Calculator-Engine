...
v5.apply_appearance_async = function(_, p_u_6, p_u_7) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.NanobiiWand, function(p8) --[[ Line: 20 ]]
...
v5.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 44 ]]
    return "rbxassetid://115855570745206";
end;
return v5;

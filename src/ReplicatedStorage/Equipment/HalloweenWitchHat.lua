...
v5.requires_apply_appearance_async = function(_) --[[ Name: requires_apply_appearance_async ]] --[[ Line: 41 ]]
    return true;
end;
v5.apply_appearance_async = function(_, p_u_6, p_u_7) --[[ Name: apply_appearance_async ]] --[[ Line: 42 ]]
    --[[ Upvalues: (copy 1): v_u_1, (copy 2): v_u_4 ]]
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.WitchHatV2, function(p8) --[[ Line: 43 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_6, (copy 3): p_u_7 ]]
        if p8 then
            v_u_1:attach_character_accessory(p_u_6, p8)
        end;
        local _, _, v9, v10 = v_u_1:create_particle_emitter_accessory(p_u_6, "HatAttachment", Vector3.new(2, 2, 0.05), "http://www.roblox.com/asset/?id=7785174921")
        v9.Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, Color3.fromRGB(72, 23, 145)), ColorSequenceKeypoint.new(1, Color3.fromRGB(72, 23, 145)) })
...
v5.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 82 ]]
...
v5.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 90 ]]
    return 50;
end;
v5.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 93 ]]
    return 3;
end;
v5.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 96 ]]
    return "rbxassetid://11372253520";
end;
return v5;

...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "Halloween Witch\'s Skirt";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    local v_u_9 = v_u_5:new(2, function() --[[ Line: 20 ]]
        --[[ Upvalues: (copy 1): p_u_8 ]]
        p_u_8()
    end)
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.WitchSkirt, function(p10) --[[ Line: 23 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.WitchSkirtAccessories, function(p11) --[[ Line: 29 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p11 then
...
v6.modify_equip_data_params = function(_, p12) --[[ Name: modify_equip_data_params ]] --[[ Line: 37 ]]
    p12.PantsSlotClearDefaultPants = false
end;
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 41 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 44 ]]
    return 3;
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 47 ]]

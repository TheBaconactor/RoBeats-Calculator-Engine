...
v4.apply_appearance = function(_, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v6, v7, v8, _ = v_u_1:create_accessory_base(p5, "MaxzyMask", "FaceFrontAttachment", "rbxassetid://9645725860", "rbxassetid://9645725975")
    v6.AttachmentForward = Vector3.new(0, 0, -1)
    v6.AttachmentPos = Vector3.new(0, 0.73, 0.02)
    v6.AttachmentRight = Vector3.new(1, 0, 0)
    v6.AttachmentUp = Vector3.new(0, 1, 0)
    v7.Position = Vector3.new(0, 0.15, -0.15)
    v8.Offset = Vector3.new(0, 0, 0)
    v8.Scale = Vector3.new(0.85, 0.6, 0.75)

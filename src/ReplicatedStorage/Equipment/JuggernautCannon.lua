...
v5.apply_appearance_async = function(_, p_u_6, p_u_7) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.JuggernautCannon, function(p8) --[[ Line: 20 ]]

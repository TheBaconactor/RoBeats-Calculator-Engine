...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 8 ]]
    return "Legendary Rebel\'s Trousers";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, _, v8 = v_u_1:create_accessory_base(p6, p5:get_name() .. "(Right)", "RightAnkleRigAttachment", "rbxassetid://2621363406", "rbxassetid://2369507875")
    v8.Offset = Vector3.new(0, 0.175, -0.4)
    v8.Scale = Vector3.new(0.54, 0.24, 0.54)
    v_u_1:attach_character_accessory(p6, v7)
    local v9, _, v10 = v_u_1:create_accessory_base(p6, p5:get_name() .. "(Left)", "LeftAnkleRigAttachment", "rbxassetid://2621363406", "rbxassetid://2369507875")
    v10.Offset = Vector3.new(0, 0.175, -0.4)
    v10.Scale = Vector3.new(0.54, 0.24, 0.54)
    v_u_1:attach_character_accessory(p6, v9)
    v_u_1:pants_base_apply(p6, "rbxassetid://2472341415")
end;

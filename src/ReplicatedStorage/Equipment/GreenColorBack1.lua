...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 7 ]]
    return "Vibe Ringleader\'s Band Kit";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://5536641449", "rbxassetid://5512365935")
    ...
    v9.Offset = Vector3.new(0.26, -0.15, -0.5)
    v9.Scale = Vector3.new(0.105, 0.105, 0.085)

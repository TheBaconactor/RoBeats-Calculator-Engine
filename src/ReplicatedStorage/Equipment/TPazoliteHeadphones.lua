...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "t+pazolite\'s Headshaking Headphones";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    local v_u_9 = v_u_5:new(3, function() --[[ Line: 20 ]]
        --[[ Upvalues: (copy 1): p_u_8 ]]
        p_u_8()
    end)
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.TPazoliteHeadphoneNeon, function(p10) --[[ Line: 23 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.TPazoliteHeadphoneStrap, function(p11) --[[ Line: 29 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p11 then
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.TPazoliteHeadphoneSpeaker, function(p12) --[[ Line: 35 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p12 then
...
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 43 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 46 ]]
    return 2;
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 49 ]]
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 56 ]]
    return "rbxassetid://12492815554";
end;
return v6;

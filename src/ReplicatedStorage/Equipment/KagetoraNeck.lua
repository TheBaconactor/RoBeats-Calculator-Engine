...
v5.apply_appearance_async = function(_, p_u_6, p_u_7) --[[ Name: apply_appearance_async ]] --[[ Line: 18 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.KagetoraNeck, function(p8) --[[ Line: 19 ]]
...
v5.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 36 ]]
    return 2;
end;
v5.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 39 ]]
    return "rbxassetid://18524942506";
end;
return v5;

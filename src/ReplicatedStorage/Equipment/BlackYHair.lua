...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 20 ]]
    ...
    v_u_9:begin()
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.BlackYHair, function(p10) --[[ Line: 24 ]]
    ...
    v_u_9:begin()
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.BlackYHorns, function(p11) --[[ Line: 32 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p11 then
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 57 ]]
    return "rbxassetid://82762361524486";
end;
return v6;

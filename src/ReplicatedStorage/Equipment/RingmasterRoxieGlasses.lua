...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "FaceFrontAttachment", "rbxassetid://498211539", "rbxassetid://498211717")
    v7.AttachmentForward = Vector3.new(0, 0, -1)
    v7.AttachmentPos = Vector3.new(-0.01, 0.5, 0.2)
    v7.AttachmentRight = Vector3.new(1, 0, 0)
    v7.AttachmentUp = Vector3.new(0, 1, 0)
    v8.Position = Vector3.new(-0.01, -0.1, -0.35)
    v9.Offset = Vector3.new(0, 0, 0)
    v9.Scale = Vector3.new(0.52, 0.52, 0.52)

...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "FaceCenterAttachment", "rbxassetid://8402048352", "rbxassetid://8402053859")
    ...
    v8.Position = Vector3.new(0, -0.08, 0.125)
    v8.Orientation = Vector3.new(0, 0, -0)
    v9.Offset = Vector3.new(0, 0, 0)
    v9.Scale = Vector3.new(0.025, 0.025, 0.025)

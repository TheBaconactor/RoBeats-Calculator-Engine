...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "AAAA\'s Hoshikake-kun Mask";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 18 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.AaaaMask, function(p10) --[[ Line: 22 ]]
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 43 ]]
    return "rbxassetid://17736921197";
end;
return v6;

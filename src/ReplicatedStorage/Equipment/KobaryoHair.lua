...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "HairAttachment", "rbxassetid://10034338216", "rbxassetid://10034338629")
    v7.AttachmentForward = Vector3.new(-1, 0, 0)
    v7.AttachmentPos = Vector3.new(0.018684387, 0.44036484, -0.00030517578)
    v7.AttachmentRight = Vector3.new(0, 0, -1)
    v7.AttachmentUp = Vector3.new(0, 1, 0)
    v8.Orientation = Vector3.new(0, 90, 0)
    v8.Position = Vector3.new(0.018684387, 0.44036484, -0.00030517578)

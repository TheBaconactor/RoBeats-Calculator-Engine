...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 8 ]]
    return "Ardolf\'s Lycanthrope Tail";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "WaistCenterAttachment", "rbxassetid://10307104526", "rbxassetid://10307105048")
    ...
    v8.Orientation = Vector3.new(-0, 90, -141.855)
    v8.Position = Vector3.new(-1.065, 0.637, 0.633)
    v9.Scale = Vector3.new(0.75, 0.75, 0.75)

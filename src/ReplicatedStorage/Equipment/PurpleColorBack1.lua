...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 7 ]]
    return "Flow Commander\'s Jetpack";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://5536446043", "rbxassetid://5513008211")
    ...
    v9.Offset = Vector3.new(0, 0.75, 0.2)
    v9.Scale = Vector3.new(0.12, 0.125, 0.225)

...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Beat Cyborg\'s Jumpsuit";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    v_u_1:shirt_base_apply(p8, "rbxassetid://5512485584")
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoulderLeft", "LeftShoulderRigAttachment", "rbxassetid://5263108475", "rbxassetid://5512485751")
    ...
    local v12, v13, v14 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoulderRight", "RightShoulderRigAttachment", "rbxassetid://5263108475", "rbxassetid://5512485751")
    ...
    local v15, v16, v17 = v_u_1:create_accessory_base(p8, p7:get_name() .. "HandLeft", "LeftWristRigAttachment", "rbxassetid://5263018329", "rbxassetid://5512485179")
    ...
    local v18, v19, v20 = v_u_1:create_accessory_base(p8, p7:get_name() .. "HandRight", "RightWristRigAttachment", "rbxassetid://5263018329", "rbxassetid://5512485179")
...
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 109 ]]
    ...
    return {
        [v_u_3.Type.ColorOrange] = 21,
        [v_u_3.Type.ColorPurple] = 9,
        [v_u_3.Type.FeverTime] = 7,
        [v_u_3.Type.FeverFillRate] = 7
    };
end;

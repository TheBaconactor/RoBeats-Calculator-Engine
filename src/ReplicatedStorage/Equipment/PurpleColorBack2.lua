...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Flow Commander\'s Jetpack";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name(), v_u_2:slot_to_attachment_name(p7:get_avatar_slot()), "rbxassetid://5536446043", "rbxassetid://5513008211")
    ...
    v11.Offset = Vector3.new(0, 0.75, 0.2)
    v11.Scale = Vector3.new(0.12, 0.125, 0.225)

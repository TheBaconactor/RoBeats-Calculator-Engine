...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Chill Samurai\'s Cuirass";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    v_u_1:shirt_base_apply(p8, "rbxassetid://5506749767")
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name(), "BodyFrontAttachment", "rbxassetid://5536554253", "rbxassetid://5506749465")
    ...
    v11.Offset = Vector3.new(0, 0.025, -0.2)
    v11.Scale = Vector3.new(0.04, 0.04, 0.1)
    v_u_1:attach_character_accessory(p8, v9)
    local v12, v13, v14 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoulderLeft", "LeftShoulderRigAttachment", "rbxassetid://5543701836", "rbxassetid://5506749835")
    ...
    v14.Offset = Vector3.new(-0.25, -0.5, 0)
    v14.Scale = Vector3.new(0.025, 0.025, 0.025)
    v_u_1:attach_character_accessory(p8, v12)
    local v15, v16, v17 = v_u_1:create_accessory_base(p8, p7:get_name() .. "ShoulderRight", "RightShoulderRigAttachment", "rbxassetid://5543701836", "rbxassetid://5506749835")
    ...
    v16.Orientation = Vector3.new(0, 180, -90)
    v16.Position = Vector3.new(0, 0, 0)
    v17.Offset = Vector3.new(-0.25, -0.5, 0)
    v17.Scale = Vector3.new(0.025, 0.025, 0.025)
    v_u_1:attach_character_accessory(p8, v15)
    v_u_4:attach_color_particle(v_u_5.Blue, p8)
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 88 ]]
    --[[ Upvalues: (copy 1): v_u_3 ]]
    return {
        [v_u_3.Type.ColorBlue] = 21,
        [v_u_3.Type.ColorPurple] = 10,
        [v_u_3.Type.PerfectPoints] = 9
    };
end;
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 95 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 98 ]]
    return 3;
end;
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 101 ]]

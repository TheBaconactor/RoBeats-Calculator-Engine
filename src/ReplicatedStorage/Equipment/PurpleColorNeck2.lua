...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Flow Commander\'s Harness";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name(), "BodyBackAttachment", "rbxassetid://5536445916", "rbxassetid://5513008211")
    ...
    v11.Offset = Vector3.new(0, 0.55, -0.5)
    v11.Scale = Vector3.new(0.035, 0.04, 0.07)
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 51 ]]
    return "http://www.roblox.com/asset/?id=5555642985";
end;
return v6;

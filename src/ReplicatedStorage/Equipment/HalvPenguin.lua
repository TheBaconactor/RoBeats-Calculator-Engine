...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "Halv\'s Shoulder-Pal Penguin";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    local v_u_9 = v_u_5:new(1, function() --[[ Line: 20 ]]
        --[[ Upvalues: (copy 1): p_u_8 ]]
        p_u_8()
    end)
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.HalvPenguin, function(p10) --[[ Line: 23 ]]
...
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 31 ]]
    return 50;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 34 ]]
    return 2;
end;

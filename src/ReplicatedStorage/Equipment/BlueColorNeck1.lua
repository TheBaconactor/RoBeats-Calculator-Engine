...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 7 ]]
    return "Chill Samurai\'s Necktie";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://5512977348", "rbxassetid://5506749422")
    ...
    v8.Position = Vector3.new(0, -0.053, 0.08)
    v9.Offset = Vector3.new(0, -0.2, -0.45)
    v9.Scale = Vector3.new(0.025, 0.018, 0.015)

...
v5.apply_appearance_async = function(_, p_u_6, p_u_7) --[[ Name: apply_appearance_async ]] --[[ Line: 18 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.ElectroManScarf, function(p8) --[[ Line: 19 ]]
...
v5.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 26 ]]
...
v5.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 34 ]]
    return 50;
end;
v5.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 37 ]]
    return 2;
end;
v5.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 40 ]]
    return "rbxassetid://78022994408404";
end;
return v5;

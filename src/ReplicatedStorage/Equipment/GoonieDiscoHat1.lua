...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), v_u_2:slot_to_attachment_name(p5:get_avatar_slot()), "rbxassetid://1042033211", "http://www.roblox.com/asset/?id=138949689 ")
    v7.AttachmentForward = Vector3.new(0, 0, -1)
    v7.AttachmentPos = Vector3.new(0, -0.025, -0.15)
    v7.AttachmentRight = Vector3.new(1, 0, 0)
    v7.AttachmentUp = Vector3.new(0, 1, 0)
    v8.Position = Vector3.new(0, 0.075, -0.15)
    v9.VertexColor = Vector3.new(0.7, 0.7, 0.7)
    v_u_1:attach_character_accessory(p6, v7)
end;
v4.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 34 ]]
    --[[ Upvalues: (copy 1): v_u_3 ]]
    return {
        [v_u_3.Type.ColorPurple] = 5,
        [v_u_3.Type.ColorGreen] = 3,
...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 47 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=139152149";
end;
return v4;

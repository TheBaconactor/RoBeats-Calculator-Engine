...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 10 ]]
    return "Just Dance Coach\'s Wolf Mask";
end;
...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 19 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.JustDanceWolfHat, function(p10) --[[ Line: 23 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.JustDanceWolfFace, function(p11) --[[ Line: 29 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p11 then

...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 7 ]]
    return "Flow Commander\'s Harness";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "BodyBackAttachment", "rbxassetid://5536445916", "rbxassetid://5513008211")
    ...
    v9.Offset = Vector3.new(0, 0.55, -0.5)
    v9.Scale = Vector3.new(0.035, 0.04, 0.07)

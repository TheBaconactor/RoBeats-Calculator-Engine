...
v6.apply_appearance_async = function(_, p_u_7, p_u_8) --[[ Name: apply_appearance_async ]] --[[ Line: 18 ]]
    ...
    local v_u_9 = v_u_5:new(3, function() --[[ Line: 19 ]]
        --[[ Upvalues: (copy 1): p_u_8 ]]
        p_u_8()
    end)
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.ElectroManHat1, function(p10) --[[ Line: 22 ]]
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.ElectroManHat2, function(p11) --[[ Line: 28 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p11 then
    ...
    v_u_1:load_accessory_from_modelloaddbasset(v_u_4.Accessory.ElectroManHat3, function(p12) --[[ Line: 34 ]]
        --[[ Upvalues: (ref 1): v_u_1, (copy 2): p_u_7, (copy 3): v_u_9 ]]
        if p12 then
...
v6.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 42 ]]
    return 25;
end;
v6.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 45 ]]
    return 2;
end;
v6.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 48 ]]
...
v6.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 56 ]]
    return "rbxassetid://106311422175702";
end;
return v6;

...
v3.apply_appearance = function(p4, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v6, v7 = v_u_1:create_accessory_base(p5, p4:get_name(), v_u_2:slot_to_attachment_name(p4:get_avatar_slot()), "http://www.roblox.com/asset/?id=323460542", "http://www.roblox.com/asset/?id=323460704")
    v6.AttachmentForward = Vector3.new(0, 0, -1)
    v6.AttachmentPos = Vector3.new(0, 1.5, -2.1)
    v6.AttachmentRight = Vector3.new(1, 0, 0)
    v6.AttachmentUp = Vector3.new(0, 1, 0)
    v7.Position = Vector3.new(-0, -0.5, -1.6)

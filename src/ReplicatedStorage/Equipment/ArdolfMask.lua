...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 8 ]]
    return "Ardolf\'s Lycanthrope Mask";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name(), "FaceCenterAttachment", "rbxassetid://10307135929", "rbxassetid://10307136453")
    ...
    v8.Position = Vector3.new(0.133, -0.173, 0)

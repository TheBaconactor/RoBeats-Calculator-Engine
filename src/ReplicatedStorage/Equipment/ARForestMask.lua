...
v4.apply_appearance = function(_, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v6, v7, v8 = v_u_1:create_accessory_base(p5, "ARForestMask", "FaceFrontAttachment", "rbxassetid://12948240008", "rbxassetid://12948240050")
    ...
    v7.Position = Vector3.new(0.0002746582, 0.035853386, 0.50870514)

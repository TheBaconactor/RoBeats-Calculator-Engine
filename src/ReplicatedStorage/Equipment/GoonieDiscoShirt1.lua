...
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 31 ]]
    return "https://www.roblox.com/Thumbs/Asset.ashx?width=110&height=110&assetId=653144310";
end;
return v4;

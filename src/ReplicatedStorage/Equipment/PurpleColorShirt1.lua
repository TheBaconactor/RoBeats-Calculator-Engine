...
v4.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 7 ]]
    return "Flow Commander\'s Jumpsuit";
end;
...
v4.apply_appearance = function(p5, p6) --[[ Name: apply_appearance ]] --[[ Line: 13 ]]
    ...
    v_u_1:shirt_base_apply(p6, "rbxassetid://5513008562")
    local v7, v8, v9 = v_u_1:create_accessory_base(p6, p5:get_name() .. "ShoulderLeft", "LeftShoulderRigAttachment", "rbxassetid://5263376872", "rbxassetid://5513008651")
    ...
    v9.Offset = Vector3.new(-0.5, 0.175, 0)
    v9.Scale = Vector3.new(0.03, 0.045, 0.05)
    v_u_1:attach_character_accessory(p6, v7)
    local v10, v11, v12 = v_u_1:create_accessory_base(p6, p5:get_name() .. "ShoulderRight", "RightShoulderRigAttachment", "rbxassetid://5263376872", "rbxassetid://5513008651")
    ...
    v12.Offset = Vector3.new(-0.5, 0.175, 0)
    v12.Scale = Vector3.new(0.03, 0.045, 0.05)
    v_u_1:attach_character_accessory(p6, v10)
    local v13, v14, v15 = v_u_1:create_accessory_base(p6, p5:get_name() .. "HandLeft", "LeftWristRigAttachment", "rbxassetid://5263322788", "rbxassetid://5513008134")
    ...
    v15.Scale = Vector3.new(0.03, 0.013, 0.03)
    v_u_1:attach_character_accessory(p6, v13)
    local v16, v17, v18 = v_u_1:create_accessory_base(p6, p5:get_name() .. "HandRight", "RightWristRigAttachment", "rbxassetid://5263322788", "rbxassetid://5513008134")
    ...
    v18.Scale = Vector3.new(0.03, 0.013, 0.03)
    v_u_1:attach_character_accessory(p6, v16)
end;
v4.get_gear_statmodifierobj = function(_) --[[ Name: get_gear_statmodifierobj ]] --[[ Line: 104 ]]
    --[[ Upvalues: (copy 1): v_u_3 ]]
    return {
        [v_u_3.Type.ColorPurple] = 16,
        [v_u_3.Type.ColorBlue] = 8,
        [v_u_3.Type.FeverMultiplier] = 6
    };
end;
v4.get_gear_power = function(_) --[[ Name: get_gear_power ]] --[[ Line: 111 ]]
    return 35;
end;
v4.get_gear_tier = function(_) --[[ Name: get_gear_tier ]] --[[ Line: 114 ]]
    return 2;
end;
v4.get_icon = function(_) --[[ Name: get_icon ]] --[[ Line: 117 ]]

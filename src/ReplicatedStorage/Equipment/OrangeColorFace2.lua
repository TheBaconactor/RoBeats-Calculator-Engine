...
v6.get_name = function(_) --[[ Name: get_name ]] --[[ Line: 9 ]]
    return "Legendary Beat Cyborg\'s Goggles";
end;
...
v6.apply_appearance = function(p7, p8) --[[ Name: apply_appearance ]] --[[ Line: 15 ]]
    ...
    local v9, v10, v11 = v_u_1:create_accessory_base(p8, p7:get_name(), v_u_2:slot_to_attachment_name(p7:get_avatar_slot()), "http://www.roblox.com/asset/?id=19380204", "http://www.roblox.com/asset/?id=19380195")
    ...
    v11.Offset = Vector3.new(0, 0.15, 0.2)
    v11.Scale = Vector3.new(1.1, 1, 1)

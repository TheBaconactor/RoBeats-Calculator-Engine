...
v4.apply_appearance = function(_, p5) --[[ Name: apply_appearance ]] --[[ Line: 14 ]]
    ...
    local v6, v7, v8, _ = v_u_1:create_accessory_base(p5, "KepoBeanie", "HatAttachment", "rbxassetid://8312195600", "rbxassetid://8312195748")
    ...
    v8.Offset = Vector3.new(0, 0.5, 0)
    v8.Scale = Vector3.new(0.08, 0.08, 0.08)
